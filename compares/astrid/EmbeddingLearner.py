...
class EmbeddingCNNNetwork(nn.Module):
    def __init__(self, string_helper, configs):
        ...
        # print(self.max_string_length // 8, self.alphabet_size, self.channel_size)
...
def train_embedding_model(configs, train_loader, string_helper, model_output_file_name):
    ...
    #for epoch in range(epochs):
        ...
        if model_output_file_name is not None:
            torch.save(model.state_dict(), model_output_file_name)
