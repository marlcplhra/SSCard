...
def load_query_strings_with_card(path):
    data = []
    ...
    num = df['selectivity'].astype(int).tolist()
...
if __name__ == "__main__":
    ...
    data_path = "../../datasets/"
    train_data = load_query_strings_with_card(data_path + args.dname + "/" + args.dname + "_train.csv")
    valid_data = load_query_strings_with_card(data_path + args.dname + "/" + args.dname + "_valid.csv")
    test_data = load_query_strings_with_card(data_path + args.dname + "/" + args.dname + "_test.csv")
    ...
    est = learn_Deep_Learning_model(cm, Est_class, data, is_rewirte=args.rewrite, logger=logger, exp_key=exp_key,
                                    overwrite=args.overwrite, analysis=args.analysis, analysis_latency=args.analysis_latency)
