...
if __name__ == "__main__":
    ...
    generate_like_patterns('Datasets/DBLP_AN/author_name.csv',
                           'Datasets/DBLP_AN/author_names_training_set_new.txt', train_dataset_size)
    # generate_like_patterns('likeCard_datasets/DBLP/DBLP.txt',
                        #    'likeCard_datasets/DBLP/DBLP_training_set.txt', train_dataset_size)
